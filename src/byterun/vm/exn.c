...
static const value out_of_memory_exn_s[] = {
...
static const value out_of_memory_exn[] = {
  Make_header(2, Object_tag, Color_white),
  Val_block(&out_of_memory_exn_s[1]),
  Val_int(-1)
};

const value ocaml_out_of_memory = Val_block(&out_of_memory_exn[1]);

/******************************************************************************/

static const value stack_overflow_exn_s[] = {
  Make_header(4, String_tag, Color_white),
...
static const value stack_overflow_exn[] = {
  Make_header(2, Object_tag, Color_white),
  Val_block(&stack_overflow_exn_s[1]),
  Val_int(-9)
};

const value ocaml_stack_overflow = Val_block(&stack_overflow_exn[1]);

/******************************************************************************/

static const value division_by_zero_exn_s[] = {
...
static const value division_by_zero_exn[] = {
  Make_header(2, Object_tag, Color_white),
  Val_block(&division_by_zero_exn_s[1]),
  Val_int(-6)
};

const value ocaml_division_by_zero = Val_block(&division_by_zero_exn[1]);

/******************************************************************************/

static const value invalid_argument_exn_s[] = {
  Make_header(5, String_tag, Color_white),
...
static const value invalid_argument_exn[] = {
  Make_header(2, Object_tag, Color_white),
  Val_block(&invalid_argument_exn_s[1]),
  Val_int(-4)
};

const value ocaml_invalid_argument = Val_block(&invalid_argument_exn[1]);
