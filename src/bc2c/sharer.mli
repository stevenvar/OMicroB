...
val find_float_array : 'a t -> float array -> 'a
val find_bytes       : 'a t -> bytes -> 'a
val find_block       : 'a t -> T.value array -> 'a
...
val put_float_array : 'a t -> float array -> 'a -> unit
val put_bytes       : 'a t -> bytes -> 'a -> unit
val put_block       : 'a t -> T.value array -> 'a -> unit
