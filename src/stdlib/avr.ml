(*******************************************************************************)
(*                                                                             *)
(*                  Arduboy avr pin communication library                      *)
(* Used for retrocompatibility only! The new GenericAvr should be used instead *)
(*                                                                             *)
(*******************************************************************************)

(* Arduboy version of the lib, for retrocompatibility *)
