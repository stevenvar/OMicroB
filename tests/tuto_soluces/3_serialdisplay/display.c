...
#define OCAML_FLASH_HEAP_WOSIZE           73
...
PROGMEM value const ocaml_flash_global_data[OCAML_FLASH_GLOBDATA_NUMBER] = {
  ...
  /*  9 */  Val_flash_block(&ocaml_flash_heap[58]),
  /* 10 */  Val_flash_block(&ocaml_flash_heap[60]),
  /* 11 */  Val_flash_block(&ocaml_flash_heap[62]),
  /* 12 */  Val_flash_block(&ocaml_flash_heap[64]),
  /* 13 */  Val_flash_block(&ocaml_flash_heap[66]),
  /* 14 */  Val_flash_block(&ocaml_flash_heap[68]),
  /* 15 */  Val_flash_block(&ocaml_flash_heap[70]),
  /* 16 */  Val_flash_block(&ocaml_flash_heap[72])
};
