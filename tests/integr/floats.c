...
#define OCAML_PUSHCONSTINT_1B          32
#define OCAML_SUBINT                   33
#define OCAML_NEQ                      34
#define OCAML_GTINT                    35
#define OCAML_OFFSETINT_1B             36
#define OCAML_STOP                     37
...
PROGMEM opcode_t const ocaml_bytecode[OCAML_BYTECODE_BSIZE] = {
  ...
  /* 109 */  OCAML_C_CALL1,
  /* 110 */  6,
  /* 111 */  OCAML_PUSHCONSTINT_1B,
  /* 112 */  100,
  /* 113 */  OCAML_PUSHACC2,
  /* 114 */  OCAML_APPLY1,
  /* 115 */  OCAML_ACC0,
  /* 116 */  OCAML_PUSHCONST0,
  /* 117 */  OCAML_C_CALL1,
  /* 118 */  6,
  /* 119 */  OCAML_SUBINT,
  /* 120 */  OCAML_PUSH,
