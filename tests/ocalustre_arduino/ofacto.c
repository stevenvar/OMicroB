...
val_t ocaml_heap[OCAML_HEAP_WOSIZE * 2] = {
  ...
  /* 3 */  Val_codeptr(19),
  /* 4 */  Make_header(2, String_tag),
  /* 5 */  Make_string_data('f', 'i', 'n', 'i'),
  /* 6 */  Make_string_data('s', 'h', '\0', '\1')
};
